...
Token* readConstChar(void){
  ...
  if(currentChar[charCodes] == CHAR_LETTER){
  ...
  else if(currentChar[charCodes] == CHAR_BACKSLASH){
    readChar();
    if(currentChar[charCodes] == CHAR_SINGLEQUOTE){
      readChar();
      if(currentChar[charCodes] == CHAR_SINGLEQUOTE){
        readChar();
        return token;
    ...
    }else if(currentChar[charCodes] == CHAR_TAB){
      readChar();
      if(currentChar[charCodes] == CHAR_SINGLEQUOTE){
        readChar();
        return token;
    ...
    }else if(currentChar[charCodes] == CHAR_ENDLN){
      readChar();
      if(currentChar[charCodes] == CHAR_SINGLEQUOTE){
        readChar();
        return token;
